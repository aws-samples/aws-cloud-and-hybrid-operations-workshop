...
** you can turn off logging by changing the registry key HKLM\SOFTWARE\benfelip\CrazyLogs from 1 to 0 
#>

$result = 1
$number = 1
$path="C:\logfile.log"
Get-ItemProperty -Path HKLM:\SOFTWARE\benfelip -Name "CrazyLogs" 
$a = Get-ItemPropertyValue 'HKLM:\SOFTWARE\benfelip' -Name CrazyLogs
