...
- [Instructions](#instructions)
    - [Create IAM user for template reviews and change request approval](#create-iam-user-for-template-reviews-and-change-request-approval)
    - [Create an IAM service role for Automation](#create-an-iam-service-role-for-automation)
    - [Configuring Change Manager user identity management and template reviewers](#configuring-change-manager-user-identity-management-and-template-reviewers)
    - [Configuring Change Manager change freeze event approvers and best practices](configuring-change-manager-change-freeze-event-approvers-and-best-practices)
    - [Create a change template](#create-a-change-template)
    - [Approve the change template](#approve-the-change-template)
    - [Create a change request](#create-a-change-request)
    - [Approve the change request](#approve-a-change-request)
